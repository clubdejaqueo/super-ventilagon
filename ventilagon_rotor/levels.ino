...
Level levels[] = {
  Level(100000L, '1', 0x00ffff, 0xff0000, patterns_level1, elements_in(patterns_level1)),
  Level(90000L, '2', 0xff00ff, 0xff0000, patterns_level2, elements_in(patterns_level2)),
  Level(80000L, '3', 0xffff00, 0xff0000, patterns_level3, elements_in(patterns_level3)),
  Level(70000L, '1', 0x0000ff, 0xff0000, patterns_level4, elements_in(patterns_level4)),
  Level(60000L, '2', 0x00ff00, 0xff0000, patterns_level5, elements_in(patterns_level5)),
  Level(50000L, '3', 0xffffff, 0xff0000, patterns_level6, elements_in(patterns_level6)),
};
